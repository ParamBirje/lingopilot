  ...
  return (
    <section className="flex flex-col items-center justify-center gap-6 py-8 md:py-10 mt-16">
      <div className="inline-block max-w-xl text-center justify-center">
        ...
        <span className={title({ color: "violet" })}>SaaS stack&nbsp;</span>
        <br className="hidden md:block" />
        <span className={title()}>you&apos;ve been waiting for.</span>
        <div className={subtitle({ class: "mt-6" })}>
          A minimalistic, yet powerful SaaS boilerplate to kickstart your next
          project with Remix, Supabase Auth, and NextUI.
        </div>
      </div>
